...
`documentation-diataxis` 原样引入 Canonical；`documentation-structure` 和 `documentation-style` 已适配通用 Markdown；`documentation-verify` 已移除单仓库和代码作为唯一依据的假设。来源、修改说明与许可证见 [UPSTREAM.md](plugins/documentation/UPSTREAM.md)。
